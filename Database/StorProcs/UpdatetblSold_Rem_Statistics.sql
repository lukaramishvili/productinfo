...
-- =============================================
CREATE PROCEDURE [dbo].[UpdatetblSold_Rem_Statistics]
...
BEGIN
    ...
    INSERT INTO tblSold_Rem_Statistics (so_id,so_dro,cashbox_id,sName,buyer_name,store_id,zed_nomeri,using_check,whole_cost,costWithoutVAT,sold_price,paid_amount,whole_price_diff,price_diff_withoutVAT)
	SELECT *
			FROM (	
